...
const foodsInfo = `Até aqui, o array "brazilianFFoods" possui ${brazilianFoods.length} itens: ${brazilianFoods[0]}, ${brazilianFoods[1]}  ${brazilianFoods[2]}.`
...
*/
dogNames.pop()
//console.log(dogNames[dogNames.lenght - 1])
...
dogNames.push('Nina')
const initials = ` ${dogNames[0].slice(0, 1)}${dogNames[1].slice(0, 1)}${dogNames[2].slice(0, 1)}${dogNames[3][0]} `
