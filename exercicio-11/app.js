...
myAge()
//console.log(age) 'Porque a variavel criada foi atribuida aum escopo local'
...
*/
 let car = {
    ...
    getColorsMessage (){
      let colorCarAvailable = `${this.colors[0]}, ${this.colors[1]} e ${this.colors[2]}`
      console.log(`O ${this.name} está disponível nas cores ${colorCarAvailable}`)
