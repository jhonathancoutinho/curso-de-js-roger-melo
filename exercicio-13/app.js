...
const dogs = [
 ...
 console.log(dogs.find( cao => cao.name === 'Zequinha'))
...
const h1Title = document.querySelector('body > section > article > h1')
...
const sencudariosTitles = document.querySelectorAll('.secondary-title')

console.log(sencudariosTitles)